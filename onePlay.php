...
<!--
    This file is the singleplayer page and lauches the onePlay.js file which is needed for this. It also has back buttton and reset button.
-->
...
<script src="/js/onePlay.js"></script>
<div class="row">
